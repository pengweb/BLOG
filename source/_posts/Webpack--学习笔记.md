...
需要安装的插件有：`style-loader``css-loader``jsx-loader``sass-loader``less-loader``babel-loader`` babel-preset-es2015``babel-preset-react `
我们看看下方的示例：
```js
...
这时候我们需要使用[exports-loader](https://github.com/webpack/exports-loader) 来帮忙：
```js
...
这时候我们需要[extract-text-webpack-plugin](https://github.com/webpack/extract-text-webpack-plugin)来帮忙：
```js
    var webpack = require('webpack');
    var commonsPlugin = new webpack.optimize.CommonsChunkPlugin('common.js');
...
我们倒也可以使用 [script.js](https://github.com/ded/script.js)
```js
